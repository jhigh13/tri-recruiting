...
Run this after starting the PostgreSQL container to initialize the schema.
...
def create_tables() -> None:
    ...
    try:
        ...
        print("\nTroubleshooting:")
        print("1. Ensure PostgreSQL is running: docker compose -f docker/postgres-compose.yml up -d")
        print("2. Check your .env file has correct DATABASE_URL")
        print("3. Verify database credentials and connection string")
        sys.exit(1)
